...
//Admin Login Section
	...
	public ModelAndView login(HttpSession session ,@ModelAttribute Admin m){
...
//View Toll Details 
	...
	public ModelAndView view_toll(){
		...
		return new ModelAndView("view_toll","list",list);
	}
...
/*//Print Tolls
	@RequestMapping(value="/printtoll",method=RequestMethod.GET)
