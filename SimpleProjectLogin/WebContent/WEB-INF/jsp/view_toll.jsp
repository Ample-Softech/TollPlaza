        ...
        <div class="container">
            <div class="row">
             		<div class="col-md-8 col-sm-12">
                        <h2 class="head-title">View Toll Page</h2>
                        <hr class="botm-line">
            			<h2>Welcome...</h2>
	                	...
	                	<thead>
	                		<tr><th>Toll Id</th><th>Name</th><th>Address</th><th>Owner</th><th>Start Date</th><th>Edit</th><th>Delete</th></tr>
	                	</thead>
	                	<tbody>
						   ...
						   <tr>  
							   <td>${emp.tollid}</td>  
							   <td>${emp.tollname}</td>  
							   <td>${emp.tolladdress}</td>
							   <td>${emp.tollowner}</td>
							   <td>${emp.tollstartdate}</td>	
							   <td><a href="edittoll/${emp.tollid}">Edit</a></td>
							   <td><a href="deletetoll/${emp.tollid}">Delete</a></td>						     
						   </tr>  
						   </c:forEach>  	
	                	</tbody>
	   				</table>
            					<a href="printtoll">Print</a>
                </div>
            </div>
        </div>
    </section>
